...
public class WorldRenderer implements Disposable{
	...
	*/
	...
	private void renderGuiScore(SpriteBatch batch) {
		...
		Assets.instance.fonts.defaultNormal.draw(batch, " " + worldController.score, x + 70, y + 42.5f);
	}
	...
	private void renderGuiLives(SpriteBatch batch) {
		...
		for(int i = 0; i < Constants.LIVES_START; i++) {
			...
			batch.draw(Assets.instance.knight.knight, x + i * 50, y, 50, 50, 150, 120, 0.35f, -0.35f, 0);
		}
	}
